...
namespace PhasmophobiaMenuExternal.Utils
{
    public class VisualUtil
    {
        ...
        {
            DrawList.AddRect(topLeft, bottomRight, ImGui.ColorConvertFloat4ToU32(color), 0f, ImDrawFlags.None, thickness);
        }
        ...
        {
            DrawList.AddCircle(center, radius, ImGui.ColorConvertFloat4ToU32(color), 0, thickness);
        }

        public static void DrawLine(Vector2 point1, Vector2 point2, Vector4 color, float thickness = 1f)
        {
            DrawList.AddLine(point1, point2, ImGui.ColorConvertFloat4ToU32(color), thickness);
        }
    }
}
